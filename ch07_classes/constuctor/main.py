...
class Student:
    ...
    def set_age(self, age):
        if 0 <= age <= 200:
            ...
            raise ValueError("나이는 0살 이상, 200살 이하만 가능합니다.")
    ...
    def set_score(self, score):
        if 0.0 <= score <= 4.5:
            ...
            raise ValueError("점수는 0.0 이상, 4.5 이하만 가능합니다.")
    # getter 예시
    def get_name(self):
        return self.name
...
set_age()의 경우에 내부에 로직으로 0살 미만과 200살 초과의 나이는 입력이 블가능하게끔 하겠습니다.
...
print(f'{student1.get_age()}')      # 결과값 : 20